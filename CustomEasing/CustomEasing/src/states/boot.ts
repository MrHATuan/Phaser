module CustomFrames {
    ...
    export class Boot extends Phaser.State {
        ...
        create() {
            ...
            // chart axis
            var bg: Phaser.Image = this.add.image(this.world.centerX, this.world.centerY, "bg");
            bg.anchor.setTo(0.5, 0.5);

            // ball sprite
            var ballX = 105;
            var ballY = 278;
            var ball: Phaser.Sprite = this.add.sprite(ballX, ballY, "ball");
            ...
            // move tween
            var moveTween1: Phaser.Tween = this.game.add.tween(ball);
            moveTween1.to({ x: ballX + 150 }, 1500, Phaser.Easing.Linear.None);
            var moveTween2: Phaser.Tween = this.game.add.tween(ball);
            ...
            // bounce tween 2
            var bounceTween2: Phaser.Tween = this.game.add.tween(ball);
            bounceTween2.to({ y: ballY - 150 }, 1500, function (k) {
                return self._easing2.easing(k);
            });
            // bounce tween 3
            var bounceTween3: Phaser.Tween = this.game.add.tween(ball);
            bounceTween3.to({ y: ballY - 150 }, 2500, function (k) {
                return self._easing3.easing(k);
            });
            // bounce tween 4
            var bounceTween4: Phaser.Tween = this.game.add.tween(ball);
            ...
            // switching tweens
            this.input.keyboard.addCallbacks(this, null, null, function (aChar: string) {
        ...
        leaveIncorrectOrientation() {
            ...
            Globals.correctOrientation = true;
