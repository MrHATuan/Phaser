var Factory = function(game, parent, x, y){
    var factory1, factory3, factory4, factory5, 
    factory1_1, factory3_1, factory4_1, factory5_1;
...
Factory.prototype = {
    initFactory: function(game, parent, x, y){
        ...
        factory4   = factoryGroup.create(39, 107, 'factory5');
        factory4_1 = factoryGroup.create(32, -95, 'factory5_1');
        factory5   = factoryGroup.create(6, 155, 'factory4');
        factory5_1 = factoryGroup.create(3, -102, 'factory4_1');
    ...
    buildingFactory: function(factory) {
        switch(factory) {
            ...
            case 3:
                this.building = 4;
                this.building = 3;
                var factoryTween = this.game.add.tween(factory5).to({ y: -102 }, 1000, "Sine.easeInOut", true);
                factoryTween.onComplete.add(function() {
            ...
            case 4:
                this.building = -1;
                var factoryTween = this.game.add.tween(factory4).to({ y: -95 }, 1000, "Sine.easeInOut", true);
                factoryTween.onComplete.add(function() {
